...
export const GET_MESSAGES_CHAT_REQUEST="GET_MESSAGES_CHAT_REQUEST" ;
export const GET_MESSAGES_CHAT_SUCCESS="GET_MESSAGES_CHAT_SUCCESS" ;
export const GET_MESSAGES_CHAT_FAILURE="GET_MESSAGES_CHAT_FAILURE" ;